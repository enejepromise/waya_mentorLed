...
class TransactionAdmin(admin.ModelAdmin):
    list_display = ('id', 'name_child', 'amount', 'type', 'status', 'created_at', 'completed_at')
    search_fields = ('child__name', 'parent__full_name', 'description')
...
class AllowanceAdmin(admin.ModelAdmin):
    list_display = ('full_name_parent', 'name_child', 'amount', 'frequency', 'status', 'created_at', 'last_paid_at', 'next_payment_date')
    search_fields = ('parent__full_name', 'child__name')
    list_filter = ('status', 'frequency', 'created_at')
    readonly_fields = ['created_at', 'last_paid_at', 'next_payment_date']
